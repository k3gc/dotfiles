...
function install_dotfiles(){
	...
	dependencias=(kitty bspwm sxhkd polybar dunst rofi engrampa zsh cmatrix pcmanfm lxappearance nitrogen ranger cmus arandr light i3lock blueman xsetroot feh htop git pavucontrol hexyl zsh-syntax-highlighting zsh-autosuggestions)
